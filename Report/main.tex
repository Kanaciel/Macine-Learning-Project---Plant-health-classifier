...
\section{Methodology}
	...
	\subsection{Classification}
		...
		The multi-channel feature maps extracted by the EfficientNetB0 backbone are flattened into a one-dimensional feature vector. A Dropout layer with a rate of 0.2 is applied prior to classification to mitigate overfitting. The features are then processed by a fully connected layer with 512 neurons and ReLU activation, followed by a 10-neuron output layer that generates the class logits.
